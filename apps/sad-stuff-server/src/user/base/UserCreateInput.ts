...
class UserCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => DetectionLogCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => DetectionLogCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => DetectionLogCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => AudioSampleCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => AudioSampleCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => AudioSampleCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
